...
#set text(font: "Libertinus Serif", size: 13pt, lang: "de", region: "DE")
...
#show figure.caption: set text(size: 11.5pt)
...
#show heading.where(level: 2): set text(size: 15.5pt)
#show heading.where(level: 2): set block(above: 1.5em, below: 0.75em)
#show heading.where(level: 3): set text(size: 13.5pt)
...
#align(center)[
  ...
  #v(15mm)
  #text(size: 13pt)[vorgelegt von]
  #v(3mm)
  #text(size: 16.5pt, weight: "bold")[Omar Altanbakji]
  #v(1fr)
...
#[
  // Satz im kurzen Schlusskapitel leicht verdichten; die 13-pt-Schrift bleibt.
  #set par(leading: 0.5em, spacing: 0.45em)
